...
public class ClsPrincipal {
    ...
    private void Editarbd(){
        ...
        vendedores.Editar(nombreArchivo, nombre, codigo, 1);
        vendedores.Editar(nombreArchivo, String.valueOf(enero), codigo, 2);
        vendedores.Editar(nombreArchivo, String.valueOf(febrero), codigo, 3);
        vendedores.Editar(nombreArchivo, String.valueOf(marzo), codigo, 4);
